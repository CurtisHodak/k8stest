...
resource "aws_eks_node_group" "eks_node_group" {
  ...
  remote_access {
    ec2_ssh_key = "personal" # Replace with your key pair name
  }
  ...
  depends_on = [
    ...
    aws_eks_access_entry.curtis,
    aws_eks_access_entry.spacelift,
    aws_eks_access_policy_association.chclusteradmin,
    aws_eks_access_policy_association.chnode,
    aws_eks_access_policy_association.curtis,
    aws_eks_access_policy_association.spacelift
  ]
...
resource "kubernetes_namespace" "terraform-k8s" {
  ...
  depends_on = [aws_iam_role_policy_attachment.eks_node_group_policy,
    ...
    aws_eks_access_policy_association.chnode,
    aws_eks_access_policy_association.curtis,
    aws_eks_access_policy_association.sleks,
    aws_eks_access_policy_association.slnode,
    aws_eks_access_policy_association.slcluster
    ]
}
...
resource "aws_eks_access_entry" "curtis" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
  principal_arn = "arn:aws:iam::748229905537:user/curtisdev1"
  type          = "STANDARD"
}

resource "aws_eks_access_policy_association" "curtis" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
...
resource "aws_eks_access_policy_association" "chnode" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
...
resource "aws_eks_access_policy_association" "chclusteradmin" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
...
resource "aws_eks_access_entry" "spacelift" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
  principal_arn = "arn:aws:iam::748229905537:role/spacelift"
  type          = "STANDARD"
}

resource "aws_eks_access_policy_association" "sleks" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
  policy_arn    = "arn:aws:eks::aws:cluster-access-policy/AmazonEKSAdminPolicy"
  principal_arn = "arn:aws:iam::748229905537:role/spacelift"
  ...
  resource "aws_eks_access_policy_association" "slnode" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
  policy_arn    = "arn:aws:eks::aws:cluster-access-policy/AmazonEKSAutoNodePolicy"
  principal_arn = "arn:aws:iam::748229905537:role/spacelift"
...
resource "aws_eks_access_policy_association" "slcluster" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
  policy_arn    = "arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy"
  principal_arn = "arn:aws:iam::748229905537:role/spacelift"
